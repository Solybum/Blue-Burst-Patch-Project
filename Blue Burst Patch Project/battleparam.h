...
namespace BattleParam
{
    enum class BPIndex : uint8_t
    {
        ...
        /// Greatest index that is used by vanilla
        END_INDEX = ep1_SoDimenian__ep2_SoDimenian__ep4_None,

        /// The vanilla bp tables each have 96 entries
        MAX_INDEX = 95,
