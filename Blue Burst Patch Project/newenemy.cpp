...
void NewEnemy::Destruct(bool32 freeMemory)
{
...
void NewEnemy::UseAnimation(Animation newAnim)
{
...
void NewEnemy::PlayAnimationFullyOnce(Animation anim)
{
    UseAnimation(anim);
...
void NewEnemy::FaceTowardsTarget()
{
...
void NewEnemy::SnapToMapSurface()
{
...
void NewEnemy::CollideWithEntities()
{
...
bool NewEnemy::IsValidTarget(MapObjectWrapper& obj) const
{
    // Object is a box
...
void NewEnemy::SearchForNewTarget()
{
...
void NewEnemy::UpdateTargetExistence()
{
